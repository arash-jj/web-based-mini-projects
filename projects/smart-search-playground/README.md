...
**Arash Jafarpour** — [GitHub](https://github.com/arash-jj)

---

## 📞 Support

Have questions or found a bug? Open an [issue](https://github.com/arash-jj/Web-based-JavaScript-games/issues) on GitHub.
...
- [IMDb IAI API](https://www.iamidiotareyoutoo.com/) — Movie data

---

**Made with ❤️ by the SSP Team**
